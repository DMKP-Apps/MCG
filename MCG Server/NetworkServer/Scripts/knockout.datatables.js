    ...
    'init': function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
        ...
        if (binding.columns && binding.columns.length) {
            ...
            ko.utils.arrayForEach(binding.columns, function (col) {
                ...
                //options.columns.push({ "title": col.title, "data": col.data });
        ...
        if (binding.responsive) {
            options.responsive = binding.responsive;
        }
        ...
        //            accesor = eval("srcData['" + column.data.replace(".", "']['") + "']");
        ...
        var dtAPI = $(element).dataTable().api()
        $(element).on('draw.dt', function (e, s) {
            dtAPI.responsive.rebuild();
